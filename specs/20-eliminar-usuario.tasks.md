...
## Task 20.1 — Server Action + botón en `/admin/usuarios` ✅ completada, verificada en producción
...
## Task 20.2 — Verificación end-to-end ✅ completada
Confirmado por el usuario en producción: el botón aparece correctamente en las filas de otros usuarios, se oculta en la propia, y la confirmación funciona bien.
