...
## Task 19.1 — Página `/casos/nuevo` + Server Action ✅ completada, verificada en producción
...
## Task 19.2 — Verificación end-to-end ✅ completada
Confirmado por el usuario en producción: crear un caso válido, rechazar RUT inválido, y OT+Concepto duplicado yendo a la cola de revisión funcionan correctamente.
