...
## Task 15.2 — UI: selector de motivo en `EstadoSelector` ✅ implementada (verificación manual pendiente hasta Task 15.4)
...
## Task 15.3 — Mostrar motivo en `/casos/[id]` ✅ implementada (verificación manual pendiente hasta Task 15.4)
