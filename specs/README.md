...
| 08 | [Notificaciones automáticas](08-notificaciones.md) | 01, 02, 03, 05 | ✅ Completa en su alcance in-app, verificada en producción; envío por email (Task 8.7) descartado por decisión del usuario — ver [tasks](08-notificaciones.tasks.md) |
...
| 15 | [Motivo de rechazo](15-motivo-rechazo.md) | 04 | ✅ Completa (ver [tasks](15-motivo-rechazo.tasks.md)), verificada en producción |
| 16 | [Eliminar documentos e importaciones por error](16-eliminar-documentos-importaciones.md) | 02, 03, 05 | 📋 Propuesta, pendiente de aprobación — ver [tasks](16-eliminar-documentos-importaciones.tasks.md) |
...
## Siguiente paso
El MVP original y todo el backlog de mejoras propuesto están completos. El envío de notificaciones por email (Task 8.7) queda descartado por decisión del usuario (2026-09-21) — se mantienen solo las notificaciones in-app.
