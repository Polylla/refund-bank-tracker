...
## Task 5.0 — Migración: Documento muchos-a-muchos con CasoReembolso
...
## Task 5.1 — Extracción de N° de boleta desde nombre de archivo (TDD)
...
## Task 5.3 — Alertas: documentos sin match + casos sin documento (TDD)
...
## Task 5.4 — UI de subida y alertas
